...
# ----------------------
# 指定保存图形的目录
output_dir <- "d:/JianMoXiaosai/high_school_edu_plots"  # 修改为您希望保存图形的目录
...
df <- data.frame(
  ...
  y = c(385344,565780,540500,534065,545557,529391,536306,547321,581167,582427,560100), # 在校生人数
...
# ----------------------
# 预测未来3年的数据
forecast_result <- forecast(best_model, xreg = matrix(c(29, 181824, 29, 183275, 29, 215452), ncol = 2, byrow = TRUE), h = 3)
